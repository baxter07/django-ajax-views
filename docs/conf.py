...
texinfo_documents = [
    (master_doc, 'django-ajax-views', 'django-ajax-views Documentation',
     author, 'django-ajax-views', 'One line description of project.',
     'Miscellaneous'),
]
...
# pdf_documents = [
#     ('index', u'Certification Tool Documentation', u'Certification Tool Documentation', u'Emanuel Hafner'),
# ]
...
# pdf_style_path = ['.']
# pdf_style_path = ['C:\LocalData\src\django-ajax-views\docs\_styles\sphinx.style']
